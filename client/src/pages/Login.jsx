      ...
      <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
        ...
        <div>
          <div className='flex items-center gap-3 mb-4 max-md:mt-10'>
            ...
            <div>
              <div className='flex' >
                {Array(5).fill(0).map((_, i) => (<Star key={i} className='size-4 md:size-4.5 text-transparent fill-amber-500' />))}</div>
          ...
          <p className='text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md'>Connect with the global community on pingup.</p>
        </div>
